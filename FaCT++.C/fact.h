...
const char *fact_get_ersion ();

fact_reasoning_kernel *fact_reasoning_kernel_new ();
fact_reasoning_kernel_free (fact_reasoning_kernel *);
...
void fact_set_progress_monitor (fact_progress_monitor *);
...
void fact_realise_kb (fact_realise_kb *);

bool fact_is_functional (fact_reasoning_kernel *, fact_o_role_expression *r);
bool fact_is_functional (fact_reasoning_kernel *,
			 fact_data_value_expression *r);
...
void fact_get_sup_roles (fact_reasoning_kernel *, fact_role_expression *r,
			 fact_actor *actor);
void fact_get_sub_roles (fact_role_expression *, fact_role_expression *r,
			 bool direct, fact_actor *actor);
void fact_get_quivalent_roles (fact_reasoning_kernel *, fact_role_expression *r,
			       fact_actor *actor);
...
void fact_get_instances (fact_reasoning_kernel *, fact_concept_expression *c,
			 fact_actor *actor);
void fact_get_types (fact_reasoning_kernel *, fact_individuality_expression *i,
		     bool direct, fact_actor *actor);
void fact_get_same_as (fact_reasoning_kernel *,
		       fact_individuality_expression *i, fact_actor *actor);
