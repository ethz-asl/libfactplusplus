...
public class FaCTPlusPlus {
     ...
     */
    public native DataTypePointer getDataTop() throws Exception;
    ...
    public native ClassPointer getDataAtLeast(int num, DataPropertyPointer r, DataTypeExpressionPointer d) throws Exception;

    public native ClassPointer getDataExact(int num, DataPropertyPointer r, DataTypeExpressionPointer d) throws Exception;

    public native ClassPointer getDataAtMost(int num, DataPropertyPointer r, DataTypeExpressionPointer d) throws Exception;
    ...
    public native void tellDataPropertyRange(DataPropertyPointer s, DataTypeExpressionPointer d) throws Exception;
