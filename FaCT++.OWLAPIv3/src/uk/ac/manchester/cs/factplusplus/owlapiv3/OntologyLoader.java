...
public class OntologyLoader {
    ...
    private OWLOntologyChangeVisitor changeVisitor = new OWLOntologyChangeVisitorAdapter() {
    ...
    public OntologyLoader(OWLOntologyManager owlOntologyManager, TranslatorImpl translator) {
